package com.logate.crmdev.config;

import com.logate.crmdev.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.logate.crmdev.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.logate.crmdev.repository.search")
